...
<head>
  ...
  <script src="https://cdn.jsdelivr.net/gh/japanga/fakechan/core/dummy-js-file.js"></script>
</head>
<body>
...
document.getElementById('passwordForm').addEventListener('submit', async function(event) {
  ...
  const inputField = document.getElementById("userText");
    ...
    try {
        ...
        const response = await fetch('passwords.txt'); // Assuming passwords.txt is in the same directory
        if (!response.ok) {
  ...
  name: "UNREGISTERED"
    ...
    previewImages.forEach(img => {
      ...
      localStorage.setItem('storedText', inputField.value);
       ...
       window.location.href = "https://fakechan.staticrun.app/jsonimagetesting";
    });
